...
/**
 * Takeaways:
 * 1) Jest mock functions to test Controlled component
 * 2) Create Ref in test to check current value to test Uncontrolled component
 */

function setUpControlledSwitch(options = {}) {
...
function setUpUncontrolledSwitch(options = {}) {
